...
\begin{document}
\singlespacing
\title{Some details on SuSiE Derivation}
\author{Gao Wang}
\maketitle

\begin{abstract}
Here we fill up some technical gaps on the \susie manuscript, mostly algebreic results for \susie VEM updates and ELBO calculation.
\end{abstract}
