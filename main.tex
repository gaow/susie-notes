...
\author{Gao Wang and Yuxin Zou}
\maketitle

\begin{abstract}
This document fills some technical gaps in \susie manuscript, mostly algebraic results for \susie VEM updates and ELBO calculation.
\end{abstract}
